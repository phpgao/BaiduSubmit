...
class BaiduSubmit_Plugin implements Typecho_Plugin_Interface
{
    ...
    public static function activate()
    {
        ...
        Helper::addRoute('BaiduSubmit', '/wp-content/plugins/baidusubmit/checksign.php', 'BaiduSubmit_Action', 'action');
        return "安装成功！";
    }
    ...
    public static function configHandle($config, $is_init){
        ...
        if(!is_null($config['renew']) || $is_init){
            ...
            $url = $site_url .'wp-content/plugins/baidusubmit/checksign.php?checksign='.$config['checksign'];
